...
// Thank you Ghosti for the reference code <3
public class APBFMachine extends WorkableMultiblockMachine implements IDisplayUIMachine {

    public static final int MAX_PARALLELS = 4;

    public APBFMachine(IMachineBlockEntity holder, Object... args) {
        super(holder, args);
    }
