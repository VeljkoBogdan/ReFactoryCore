...
public class ManaBurners {
    ...
    // removed until custom mana burner logic is finished
    // public static final MultiblockMachineDefinition HIGH_VOLTAGE_MANA_BURNER =
    // ReFactoryMachineUtils.registerManaBurner(
    // REGISTRATE,
    // "hv_mana_burner", HV,
