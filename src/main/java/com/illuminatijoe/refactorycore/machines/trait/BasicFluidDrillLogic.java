...
import com.illuminatijoe.refactorycore.machines.multiblock.electric.BasicFluidDrillMachine;
...
public class BasicFluidDrillLogic extends RecipeLogic {
    ...
    public BasicFluidDrillLogic(BasicFluidDrillMachine machine) {
        super(machine);
    }

    @Override
    public BasicFluidDrillMachine getMachine() {
        return (BasicFluidDrillMachine) super.getMachine();
    }
    ...
    private int getFluidToProduce(FluidVeinWorldEntry entry) {
        ...
        if (definition != null) {
            ...
            int produced = (int) (Math.max(depletedYield,
